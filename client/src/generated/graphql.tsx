...
export type RegUserFragment = { __typename?: 'User' } & Pick<
   User,
   '_id' | 'username' | 'completedProblems'
> & { progress?: Maybe<{ __typename?: 'UserProgress' } & Pick<UserProgress, 'level' | 'points'>> }
...
export type ChangePasswordMutation = { __typename?: 'Mutation' } & {
   changePassword: { __typename?: 'User' } & RegUserFragment
}
...
export type SubmitResultMutation = { __typename?: 'Mutation' } & {
   submitResult?: Maybe<
      { __typename?: 'Result' } & Pick<Result, 'success'> & {
            solution?: Maybe<{ __typename?: 'Solution' } & Pick<Solution, '_id' | 'solution'>>
            errors?: Maybe<
               Array<
...
export type UpdateUserMutation = { __typename?: 'Mutation' } & {
   updateUser: { __typename?: 'User' } & RegUserFragment
}
...
export type UpdateUserProgressMutation = { __typename?: 'Mutation' } & {
   updateUserProgress: { __typename?: 'User' } & RegUserFragment
}

export type GetAllProblemsQueryVariables = Exact<{ [key: string]: never }>

export type GetAllProblemsQuery = { __typename?: 'Query' } & {
   getAllProblems: Array<
      Maybe<
         { __typename?: 'Problem' } & Pick<
            Problem,
            | '_id'
            | 'name'
            | 'description'
...
export type GetManyGroupsOfProblemsQuery = { __typename?: 'Query' } & {
   getManyGroupsOfProblems: { __typename?: 'manyGroupRes' } & {
      g1?: Maybe<Array<Maybe<{ __typename?: 'Problem' } & RegProblemFragment>>>
      g2?: Maybe<Array<Maybe<{ __typename?: 'Problem' } & RegProblemFragment>>>
      g3?: Maybe<Array<Maybe<{ __typename?: 'Problem' } & RegProblemFragment>>>
      g4?: Maybe<Array<Maybe<{ __typename?: 'Problem' } & RegProblemFragment>>>
      g5?: Maybe<Array<Maybe<{ __typename?: 'Problem' } & RegProblemFragment>>>
   }
}
...
export type GetSolutionQuery = { __typename?: 'Query' } & {
   getSolution?: Maybe<{ __typename?: 'Solution' } & Pick<Solution, '_id' | 'solution'>>
}
...
export function useUpdateUserProgressMutation() {
   return Urql.useMutation<UpdateUserProgressMutation, UpdateUserProgressMutationVariables>(
...
export function useGetAllProblemsQuery(
   options: Omit<Urql.UseQueryArgs<GetAllProblemsQueryVariables>, 'query'> = {}
) {
...
export function useGetManyGroupsOfProblemsQuery(
   options: Omit<Urql.UseQueryArgs<GetManyGroupsOfProblemsQueryVariables>, 'query'> = {}
) {
   return Urql.useQuery<GetManyGroupsOfProblemsQuery>({
...
export function useGetSolutionQuery(
   options: Omit<Urql.UseQueryArgs<GetSolutionQueryVariables>, 'query'> = {}
) {
